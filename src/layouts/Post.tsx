      ...
      <div className='container h-screen mx-auto'>
        <div className='grid grid-cols-12 gap-4'>
          <nav className='flex items-center w-full col-span-12 h-14'>
            ...
            <i className='flex justify-end text-2xl iconoir-cancel grow' />
          </nav>
            ...
            <div className='block w-full bg-white rounded-lg outline outline-1 outline-neutral-500/20'>
              ...
              >
                ...
                <input
                  ...
                  className='h-40 text-5xl font-semibold outline-none resize-none grow'
                  {...register('postTitle', {
                ...
                <div className='flex items-center justify-between h-10 px-6 -m-6 text-4xl bg-neutral-300/20'>
                  <div className='flex items-center gap-2'>
                    <a
                      href='.'
                      className='iconoir-bold icons-style'
                      target='_blank'
                    ></a>
                    <a
                      href='.'
                      className='iconoir-italic icons-style'
                      target='_blank'
                    ></a>
                    <a
                      href='.'
                      className='iconoir-link icons-style'
                      target='_blank'
                    ></a>
                    <a
                      href='.'
                    ...
                    <a
                      href='.'
                      className='iconoir-list icons-style'
                      target='_blank'
                    ></a>
                    <a
                      href='.'
                      className='iconoir-underline d-none d-lg-flex icons-style'
                      target='_blank'
                    ></a>
                    <a
                      href='.'
                      className='iconoir-quote d-none d-lg-flex icons-style'
                      target='_blank'
                    ></a>
                    <a
                      href='.'
                      className='iconoir-code d-none d-lg-flex icons-style'
                      target='_blank'
                    ></a>
                    <a
                      href='.'
                      className='iconoir-code-brackets-square d-none d-lg-flex icons-style'
                      target='_blank'
                    ></a>
                    <a
                      href='.'
                      className='iconoir-flash d-none d-lg-flex icons-style'
                      target='_blank'
                    ></a>
                    <a
                      href='.'
                      className='iconoir-media-image icons-style'
                      target='_blank'
                    ></a>
                  </div>
                ...
                <input
                  ...
                  className='h-40 text-2xl outline-none resize-none grow placeholder:p-2'
                  {...register('postBody', {
